---
description: "যখন একটা segment এর মধ্যেই একাধিক page.js load করানোর প্রয়োজন হয়, তখন এটি কাজে আসে। এটি আসলে একটা segment এর জন্য যতগুলো ফাইল ব্যবহার করা যায়, সবই করতে…"
---

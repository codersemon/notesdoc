---
description: "Application এ যদি error handle না করা হয় তাহলে পুরো application crash করবে, আর যদি সঠিকভাবে error handle করা হয়, তাহলে যেখানে error হবে শুধুমাত্র সেই অংশ…"
---

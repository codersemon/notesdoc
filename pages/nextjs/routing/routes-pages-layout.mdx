---
description: "URL এর মধ্যে Domain এর পরের অংশকে Path বলা হয়। সম্পূর্ণ path এর মধ্যকার প্রতিটা slash এর পরবর্তী যে route থাকে সেগুলোকে এক একটা Segment বলা হয়ে থাকে।"
---

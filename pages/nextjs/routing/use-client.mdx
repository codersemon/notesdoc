---
description: "nextjs by default app folder এর মধ্যকার সবকিছুই server side render করে থাকে। আর এই server sider render এর যেমন কিছু সুবিধা আছে আবার তেমন অসুবিধাও আছে।…"
---

---
description: "Server action একটি function ছাড়া আর কিছুই না। তবে, এই function এর মাধ্যমে অনেক জটিল/ বেশি কোডের কাজ খুব সহজেই অল্প কয়েক লাইনের কোড লিখেই করা সম্ভব। যেমনঃ…"
---

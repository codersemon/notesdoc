---
description: "nextjs একটি full-stack framework. তাই এখানে যেকোন database connection setup করার মাধ্যমে খুব সহজেই application কে database এর সাথে communication করানো…"
---

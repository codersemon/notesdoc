---
description: "আমরা যেহেতু DRY (Don’t Repeat Yourself) pattern follow করবো, তাই একই কোড বার বার না লিখার চেষ্টা করতে হবে। আর সেজন্যই প্রতিটা পেজের জন্য বার বার header,…"
---

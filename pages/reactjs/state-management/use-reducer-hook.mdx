---
description: "যখন useState hook ব্যবহার করি, তখন application এর সব business logics component এর মধ্যে রেখেই state manage করা হয়ে থাকে। কিন্তু, বড় application এ অনেক…"
---

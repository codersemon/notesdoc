---
description: "আমাদের application এ কোন component এর মধ্যে যদি error আসে তাহলে পুরো application crash করবে যদি আমরা error handle না করি। তাই এই application যদি Error…"
---

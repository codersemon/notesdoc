---
description: "এই পেজিনেশন নির্ভর করে সার্ভার response এর উপরে। কেননা, API যেভাবে ডেটা প্রদান করবে, সেই অনুযায়ী code লিখতে হবে। ReactQuery কিভাবে pagination করে থাকে…"
---

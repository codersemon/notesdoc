---
description: "variants একটি motion এর একটি props যেটিতে আমরা animation এর সকল property অন্য কোন ফাইলে রেখে সেখান থেকে import করে ব্যবহার করতে পারি। এভাবে modular way তে…"
---
